...
import sys
import logging
import ensembley.RLTrader.settings as settings
import ensembley.RLTrader.data_manager
from ensembley.RLTrader.policy_learner import PolicyLearner


os.environ['TF_CPP_MIN_LOG_LEVEL'] = '2'
stock_code = '068270'  # 삼성전자
...
if __name__ == '__main__':
    ...
    chart_data = data_manager.load_chart_data(
        os.path.join(settings.BASE_DIR,
                     'kosp_test.csv'.format(stock_code)))
    ...
    training_data = training_data.dropna() # 거래 정지 등에 의해 값이 없는 데이터를 제거
